...
#     actions={
#         "action_groups": ["/subscriptions/<subscription-id>/resourcegroups/VPC1/providers/microsoft.insights/actiongroups/myactiongroup"],
#         "action_properties": {
...
#     scopes=["/subscriptions/<subscription-id>/resourceGroups/VPC1"],
#     severity=4,
